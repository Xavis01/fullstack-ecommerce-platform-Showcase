...
watch(() => props.isOpen, (val) => {
    if (val) {
        selectedIds.value = new Set(props.initialSelected.map(p => p.collection_id))
...
const handleSave = () => {
    const selectedData = items.value
        ...
        .map(i => ({ collection_id: i.id, collection_name: i.name, excluir: isExcluir.value }))
            ...
            <div
                ...
                <div class="px-8 py-4 border-b border-[#eaddcf] flex flex-col gap-4 bg-white">
                    <div
                        ...
                        <span class="text-sm text-[#3a5528] font-light italic">Essas coleções:</span>
                    ...
                    <div class="relative w-full group">
                        <input v-model="searchTerm" type="text" placeholder="Buscar coleção..."
